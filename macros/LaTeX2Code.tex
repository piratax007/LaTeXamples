...
\cfoot{}
\rfoot{}
\lfoot{Este ejemplo esta publicado mediante la licencia LPPL v1.3c, usted es libre de usarlo, estudiarlo, modificarlo o compartirlo siempre que las obras derivadas las comparta bajo los mismos términos y mencione al autor original.}
...
%% Márgenes
%%------------------------------------------
\RequirePackage[top = 1cm, bottom = 1.5cm, left = 1.5cm, right = 1.5cm, foot = .5cm, include head]{geometry}
%%------------------------------------------
